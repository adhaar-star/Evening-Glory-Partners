...
import { useToken } from './frontend/src/auth/useToken';
import { useUser } from './frontend/src/auth/useUser';
import { Messages } from "./frontend/src/pages/partials/Messages"
...
export const UserInfoPage = () => {
    ...
    const saveChanges = async () => {
        try {
            const response = await axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/users/${id}`, {
                favoriteFood,
                hairColor,
                bio,
            }, {
