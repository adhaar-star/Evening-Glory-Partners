...
const RecentlyViewed = () => {
  return (
    <View style={styles.recentlyViewedMember}>
      <View
        style={[styles.positiveAttitudeLifeItIsMParent, styles.parentShadowBox]}
      >
        <Image
      ...
      <View style={styles.frameGroup}>
        ...
        >
          <Text
            style={[styles.recentlyViewedMember1, styles.requestsPosition]}
          >{`Recently Viewed Member `}</Text>
        </View>
      </View>
      <Text style={styles.memberYouHave}>Member you have recently viewed</Text>
